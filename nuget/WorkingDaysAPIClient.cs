...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/workingdays";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "month", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 12 } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 2000, Max = 2050 } }
        };
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorkingDaysAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WorkingDaysQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WorkingDaysQueryOptions options)
        {
        ...
        public ResponseObj Execute(WorkingDaysQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WorkingDaysQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WorkingDaysQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WorkingDaysQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WorkingDaysQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WorkingDaysQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WorkingDaysQueryOptions options)
        {
