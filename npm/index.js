...
class workingdaysWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/workingdays');
        }
        ...
        this.validationRules = {"country":{"type":"string","required":true,"minLength":2,"maxLength":2},"month":{"type":"integer","required":false,"min":1,"max":12},"year":{"type":"integer","required":false,"min":2000,"max":2050,"default":2026}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/workingdays`);
        }
    }
...
module.exports = workingdaysWrapper;
