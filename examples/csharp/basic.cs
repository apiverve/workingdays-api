    ...
    class WorkingDaysExample
    {
        ...
        static async Task<JsonDocument> CallWorkingDaysAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;country&quot;] &#x3D; &quot;US&quot;, [&quot;month&quot;] &#x3D; 10 };
        ...
        {
            Console.WriteLine("📤 Calling Working Days API...\n");

            var result = await CallWorkingDaysAPI();
