...
async function callWorkingDaysAPI() {
    try {
        ...
        const response = await fetch(`https://api.apiverve.com/v1/workingdays?${params}`, {
            method: 'GET',
            headers: {
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/workingdays](https://docs.apiverve.com/ref/workingdays)

---

## Use Cases

Common use cases for the Working Days API:
