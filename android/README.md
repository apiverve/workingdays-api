...
```gradle
dependencies {
    implementation 'com.github.apiverve:workingdays-api:1.1.14'
}
```
...
```java
import com.apiverve.workingdays.WorkingDaysAPIClient;
import com.apiverve.workingdays.APIResponse;
import com.apiverve.workingdays.APIException;

// Initialize the client
WorkingDaysAPIClient client = new WorkingDaysAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/workingdays](https://docs.apiverve.com/ref/workingdays)
...
- **Documentation:** [https://docs.apiverve.com/ref/workingdays](https://docs.apiverve.com/ref/workingdays)
- **Issues:** [GitHub Issues](https://github.com/apiverve/workingdays-api/issues)
