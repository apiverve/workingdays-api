...
const (
	baseURL        = "https://api.apiverve.com/v1/workingdays"
	defaultTimeout = 30 * time.Second
)

// Client is the Working Days API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Working Days API client.
...
// Execute makes a request to the Working Days API with typed parameters.
//
